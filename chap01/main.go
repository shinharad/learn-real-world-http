...
func handleDigest(w http.ResponseWriter, r *http.Request) {
	...
	if _, ok := r.Header["Authorization"]; !ok {
		w.Header().Add("WWW-Authorization", `Digest realm="Secret Zone", nonce="TgLc25U2BQA=f510a2780473e18e6587be702c2e67fe2b04afd", algorithm=MD5, qop="auth"`)
...
func main() {
	...
	http.HandleFunc("/cookie", handlerWithCookie)
